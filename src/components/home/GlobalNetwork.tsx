...
export const GlobalNetwork = () => {
  return (
    <section id="global-network" className="bg-white py-[60px] overflow-visible">
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="flex gap-16 items-center flex-wrap">
          ...
          <div className="flex-1 min-w-[320px] text-left flex flex-col gap-6">
            <div>
              ...
              <p className="text-[15.5px] text-gray-600 leading-[1.6] m-0 font-light">
                We connect global expertise with regional insights. Backed by specialists from over 25 countries, we manage a growing network of regional and representative offices.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-5 border-t border-gray-200 pt-6">
              <div>
                <h5 className="text-[14px] font-bold text-gray-900 mb-2 uppercase tracking-[0.05em]">
                  Key Offices
                </h5>
                <ul className="text-[13px] text-gray-600 flex flex-col gap-1.5 list-none p-0 m-0 font-light">
                  <li><strong className="text-gray-900 font-bold">London, UK</strong> (Corporate)</li>
                  <li><strong className="text-gray-900 font-bold">Doha, Qatar</strong> (MENA Regional)</li>
                  <li><strong className="text-gray-900 font-bold">Sharjah, UAE</strong> (SPC Free Zone)</li>
                </ul>
              </div>
              <div>
                <h5 className="text-[14px] font-bold text-gray-900 mb-2 uppercase tracking-[0.05em]">
          ...
          <div className="flex-[1.6] min-w-[320px] md:min-w-[480px] bg-gradient-to-br from-[#8B1538] to-[#5a0d1e] rounded-xl p-0 relative shadow-[0_20px_50px_rgba(139,21,56,0.2)] h-[440px] flex items-center justify-center overflow-hidden">
            
            {/* Unified SVG with Zoomed ViewBox */}
            <svg width="100%" height="100%" viewBox="370 340 280 180" xmlns="http://www.w3.org/2000/svg" className="opacity-95 relative z-[1]">
              
              {/* Real World Map Embedded via SVG Image */}
              <image href="/images/world-map.svg" x="30.767" y="241.591" width="784.077" height="458.627" style={{ opacity: 0.18, filter: 'brightness(20)' }} preserveAspectRatio="none" />

              {/* Connection Lines from Doha (527, 463) to other offices */}
              <path d="M 527 463 Q 460 410, 398 372" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="0.8" strokeDasharray="2 2" />
              ...
              <path d="M 527 463 Q 500 480, 475 495" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="0.8" strokeDasharray="2 2" />
              <path d="M 527 463 Q 580 420, 630 385" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="0.8" strokeDasharray="2 2" />
            ...
            <div className="absolute bottom-4 left-6 text-[11px] font-bold text-white/70 flex items-center gap-1.5 z-[2]">
